  ...
  if(type == "Accuracy") {
    ...
    table_vis <- table_data %>%
      ...
      gt::tab_header(
        ...
        subtitle = paste0("User & Producer Accuracy Confidence Intervals (in ", unit, ")")
      ) %>%
      gt::tab_spanner(
        label = "User Accuracy",
    ...
    # Save plot
    gt::gtsave(table_vis, paste0(plot_source, "/", plot_name))
    ...
    table_vis <- table_data %>%
      ...
      gt::tab_header(
        ...
        subtitle = paste0("User Area Confidence Intervals (in ", unit, ")")
      ) %>%
      gt::tab_spanner(
